"""
Django settings for oidc_example project.
...
SECRET_KEY = 'j9dy-nz278ze7)a08crxh^9-9^zbigq(g0kwi@$_till*njkt1'
...
ROOT_URLCONF = 'oidc_example.urls'
...
WSGI_APPLICATION = 'oidc_example.wsgi.application'
